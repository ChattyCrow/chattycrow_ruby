...
<pre>
# Send request
response = ChattyCrow.send_ios(alert: 'hello', channel: 'other_than_default', token: 'other', contacts: [ 'new_ios_id1', 'new_ios_id2' ])
...
<pre>
# Send request
response = ChattyCrow.send_android(key: 'key1', key2: 'key2', channel: 'other_than_default', contacts: [ 'new_ios_id1', 'new_ios_id2' ])
