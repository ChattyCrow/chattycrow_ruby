...
<pre>
# Send request
response = ChattyCrow.send_ios(alert: 'hello', channel: 'other_than_default', recipients: [ 'new_ios_id1', 'new_ios_id2' ])
...
<pre>
  response = ChattyCrow.add_contacts(channel: 'other_than_default', contacts: [ 'new1', 'new2exists', 'new3failed' ])
  # Response
...
<pre>
  response = ChattyCrow.add_contacts(channel: 'other_than_default', contacts: [ 'new1', 'new2failed' ])
  # Response
  # response.success_count = 1
  # response.failed_count  = 1
